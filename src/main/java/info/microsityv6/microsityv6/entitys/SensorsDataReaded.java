 ...
 */
@Entity
public class SensorsDataReaded implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SensorsDataReaded)) {
            return false;
        }
        SensorsDataReaded other = (SensorsDataReaded) object;
    ...
    public String toString() {
        return "info.microsityv6.microsityv6.entitys.SensorsDataReaded[ id=" + id + " ]";
    }
