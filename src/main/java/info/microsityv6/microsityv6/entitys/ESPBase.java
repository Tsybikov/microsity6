 ...
 */
@Entity
public class ESPBase implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ESPBase)) {
            return false;
        }
        ESPBase other = (ESPBase) object;
    ...
    public String toString() {
        return "info.microsityv6.microsityv6.entitys.ESPBase[ id=" + id + " ]";
    }
